...
<body id="page-top" class="index">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
          ...
          // If this is the first visit in 7 days show the modal
          if ($.cookie('pop') == null) {
            ...
            $("#myModal").modal('show');
            $("#ModalTitle").html("Like saving money?");
            $.cookie('pop', '7');
         }
        });
        ...
        // Exit intent trigger for  Modal
        addEvent(document, 'mouseout', function(evt) {
              if (evt.toElement == null && evt.relatedTarget == null ) {

                  if ($.cookie('pop') == null) {
                    $("#myModal").modal('show');
                    $("#ModalTitle").html("Before you take off..");
                    $.cookie('pop', '7');
                  }
                  // REMOVE THIS:  For demo only
                  $("#myModal").modal('show');
                  $("#ModalTitle").html("Before you take off..");
